...
<!--탑메뉴 끝-->
  ...
  <!--근육 이름 및 설명-->
  <div id="text"><h2>Back</h2>
     <div id="line"/><br/>
  <div id="text2">
  <p><xsl:value-of select="exercise/upper/back/explain"/></p>
  </div>
 </div>
 
  <!--풀업 템플릿-->
  <xsl:apply-templates select="exercise/upper/back/exercise_tool/only_body"/>
 
  <!--랫 풀 다운 템플릿-->
  <xsl:apply-templates select="exercise/upper/back/exercise_tool/machine"/>
  
  <!--벤트 오버 로우 템플릿-->
  <xsl:apply-templates select="exercise/upper/back/exercise_tool/barbell"/>
