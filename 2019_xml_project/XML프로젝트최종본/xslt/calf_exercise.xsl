...
<!--탑메뉴 끝-->
  ...
  <!--싱글 카프 레이즈 템플릿-->
  <xsl:apply-templates select="exercise/lower/calf/exercise_tool/dumbell"/>
  
  <!--레버 스탠딩 카프 레이즈-->
  <xsl:apply-templates select="exercise/lower/calf/exercise_tool/machine"/>
